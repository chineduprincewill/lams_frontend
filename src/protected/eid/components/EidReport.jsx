...
const EidReport = () => {
    ...
    const [endpoint, setEndpoint] = useState('pending-eid-report');
    ...
    const filterByStatus = (stat) => {
        setSelected(stat);
        stat === 'pending' && setEndpoint('pending-eid-report');
        stat === 'approved' && setEndpoint('approved-eid-report');
        stat === 'rejected' && setEndpoint('rejected-eid-report');
        stat === 'all' && setEndpoint('all-eid-report');
    }
