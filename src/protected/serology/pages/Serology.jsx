...
import SerologyReport from '../components/SerologyReport';
...
const Serology = () => {
    ...
    if(selected === 'report'){
        selectedComponent = <SerologyReport lga={lga} />
    }
    ...
    const icon = <MdOutlineBloodtype size={20} className="text-[#005072]" />;
